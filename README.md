...
### 5. 유사 문제 생성 (New) ✨
웹 뷰어에서 "MAGIC" 버튼을 클릭하면 **Gemini 3 Pro**를 사용하여 다음 작업을 수행합니다:
*   **유사 문제 생성**: 한국어 문제 지문, 보기(ㄱ,ㄴ,ㄷ), 5지 선다형 텍스트를 자동으로 생성합니다.
*   **그림 변환**: 문제의 이미지를 분석하여 깔끔한 **SVG** 코드로 재구성합니다.
*   **표(Tables)**: 복잡한 표 데이터도 Markdown 형식으로 완벽하게 변환하여 보여줍니다.
